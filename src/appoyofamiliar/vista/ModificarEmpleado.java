...
public class ModificarEmpleado extends javax.swing.JFrame {
    ...
    public ModificarEmpleado(Usuario padre,Usuario usuario) {
        initComponents();
        this.padre = padre;
    ...
    private void botonSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalirActionPerformed
        ...
        (new GestionarEmpleados(padre)).setVisible(true);
    }//GEN-LAST:event_botonSalirActionPerformed

    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        Plantilla.instancia().modificarEmpleado(identificadorBox.getText(), nombreBox.getText(), apellidosBox.getText(), dniBox.getText(), telefonoBox.getText(), direccionBox.getText(), localidadBox.getText());
        (new GestionarEmpleados(padre)).setVisible(true);
        this.setVisible(false);
